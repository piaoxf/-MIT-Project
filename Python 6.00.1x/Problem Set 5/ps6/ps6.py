...
def decrypt_story():
    ...
    chipertext = CiphertextMessage(get_story_string())
    return chipertext.decrypt_message()
...
worlds = load_words(WORDLIST_FILENAME)
print('legalistic'in (worlds))